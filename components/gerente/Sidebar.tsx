  ...
  const grupos: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/dashboard/gerente/solicitudes", label: "Solicitudes de líderes", icon: ClipboardList, badge: pendingSolicitudes },
        { href: "/dashboard/gerente/vacaciones",  label: "Vacaciones del equipo", icon: Umbrella },
