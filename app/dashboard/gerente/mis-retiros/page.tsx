...
import MisRetirosGerenteClient, { RetiroRow } from "./MisRetirosGerenteClient";

export default async function MisRetirosGerentePage() {
  ...
  return <MisRetirosGerenteClient retiros={retiros} />;
}
